...
export type ExerciseWorkoutArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};
...
export type GetExercisesFullQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type GetExercisesFullQuery = { __typename?: 'Query', exercises: Array<{ __typename?: 'Exercise', id: string, name: string, description?: string | null, duration?: number | null, sets?: number | null, repetitions?: number | null, video?: { __typename?: 'Asset', url: string } | null, image?: { __typename?: 'Asset', url: string } | null }> };

export type GetExercisesShortQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type GetExercisesShortQuery = { __typename?: 'Query', workout?: { __typename?: 'Workout', name: string, description?: string | null, image?: { __typename?: 'Asset', url: string } | null, exercises: Array<{ __typename?: 'Exercise', id: string, name: string, description?: string | null, duration?: number | null, image?: { __typename?: 'Asset', url: string } | null }> } | null };

export type GetProgramsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProgramsQuery = { __typename?: 'Query', programs: Array<{ __typename?: 'Program', id: string, name: string, description?: string | null, image?: { __typename?: 'Asset', fileName: string, url: string } | null }> };

export type GetWorkoutsByProgramIdQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type GetWorkoutsByProgramIdQuery = { __typename?: 'Query', programs: Array<{ __typename?: 'Program', name: string, description?: string | null, image?: { __typename?: 'Asset', fileName: string, url: string } | null, workouts: Array<{ __typename?: 'Workout', id: string, name: string, description?: string | null, image?: { __typename?: 'Asset', url: string, fileName: string } | null }> }> };


export const GetExercisesFullDocument = gql`
  ...
  exercises(where: {workout: {id: $id}}) {
    ...
    `;
export const GetExercisesShortDocument = gql`
    query getExercisesShort($id: ID!) {
  workout(where: {id: $id}) {
    name
    description
    image {
...
export const GetProgramsDocument = gql`
  ...
  programs {
    ...
    `;
export const GetWorkoutsByProgramIdDocument = gql`
...
const GetExercisesFullDocumentString = print(GetExercisesFullDocument);
const GetExercisesShortDocumentString = print(GetExercisesShortDocument);
const GetProgramsDocumentString = print(GetProgramsDocument);
const GetWorkoutsByProgramIdDocumentString = print(GetWorkoutsByProgramIdDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getExercisesFull(variables: GetExercisesFullQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetExercisesFullQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetExercisesFullQuery>(GetExercisesFullDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getExercisesFull', 'query', variables);
    },
    getExercisesShort(variables: GetExercisesShortQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetExercisesShortQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetExercisesShortQuery>(GetExercisesShortDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getExercisesShort', 'query', variables);
    },
    ...
    getWorkoutsByProgramId(variables: GetWorkoutsByProgramIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetWorkoutsByProgramIdQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetWorkoutsByProgramIdQuery>(GetWorkoutsByProgramIdDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getWorkoutsByProgramId', 'query', variables);
    }
  };
}
